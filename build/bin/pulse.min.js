...
pulse.plugin.Plugin=PClass.extend({init:function(){this._private={};this._private.types={}},subscribe:function(a,b,e,f){f=new pulse.plugin.PluginCallback({objectType:a,functionName:b,callbackType:e,callback:f,pluginManager:this});this._private.types[a]==void 0&&(this._private.types[a]={});this._private.types[a][b]==void 0&&(this._private.types[a][b]={});this._private.types[a][b][e]==void 0&&(this._private.types[a][b][e]=[]);this._private.types[a][b][e].push(f);return f},invoke:function(a,b,e,f,g){if(typeof this._private.types[a]!==
pulse.plugin._UNDEFINED&&typeof this._private.types[a][b]!==pulse.plugin._UNDEFINED&&typeof this._private.types[a][b][e]!==pulse.plugin._UNDEFINED)for(var i=this._private.types[a][b][e].length,h=0;h<i;h++)this._private.types[a][b][e][h].callback.apply(f,g)},unsubscribe:function(a){if(this._private.types[a.objectType]!=void 0&&this._private.types[a.objectType][a.functionName]!=void 0&&this._private.types[a.objectType][a.functionName][a.callbackType]!=void 0){var b=this._private.types[a.objectType][a.functionName][a.callbackType],
...
true;break}if(b){for(b=this.parent;b!==null&&!(b instanceof pulse.Engine);)b=b.parent;if(b===null)return;this._private.context.clearRect(-this.positionTopLeft.x,-this.positionTopLeft.y,b.size.width,b.size.height);for(b=0;b<this._private.orderedKeys.length;b++)if(e=this.objects[this._private.orderedKeys[b]],e instanceof pulse.Visual)e.visible?e.draw(this._private.context):e.updated=false}this._super(a);pulse.plugins.invoke(pulse.Layer.PLUGIN_TYPE,pulse.Layer.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onExit,
