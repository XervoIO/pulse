...
this.tabs={};this.tabbarLinks={};this.fpsTimer=a.fpsTimer;this.drawCounter=a.drawCounter;this.nodeCounter=a.nodeCounter;a.useDefault&&(a=new pulse.debug.tabs.Performance({name:"Performance",id:"perf",fpsTimer:a.fpsTimer,updateTimer:a.updateTimer,drawTimer:a.drawTimer}),this.addTab(a),this.addTab(new pulse.debug.tabs.Inspector({name:"Inspector",id:"inspector"})),this.addTab(new pulse.debug.tabs.Console({name:"Console",id:"console"})),this.showTab(a.id))},addTab:function(a){this.tabs[a.id]=a;var b=
this,c=document.createElement("a");c.href="#";c.innerHTML=a.name;c.onclick=function(){b.showTab(a.id);return false};c.id="pulse-tab-link-"+a.id;c.name=a.name;c.style.cssText="height: 30px; padding: 0px 10px; line-height: 30px; display: inline-block; text-decoration: none; color: #ccc;";a.icon!==""&&(c.style.cssText+="background: transparent url('"+a.icon+"') no-repeat 10px center;padding-left: 35px");a.container.style.display="none";this.tabbarLinks[a.id]=c;this.tabbar.appendChild(c);this.tabholder.appendChild(a.container)},
