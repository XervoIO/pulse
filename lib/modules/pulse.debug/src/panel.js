...
/** @lends pulse.debug.Panel.prototype */
{
  ...
  init : function (params) {
    ...
    this.panel.style.cssText =
      ...
      'left: 0px; bottom: 0px; color: #ccc; ' +
      'font: 12px Helvetica,arial,freesans,clean,sans-serif; position: fixed;';
    ...
    /**
     * Keep track of the body's original height
     * @type {number}
     */
    this.bodyHeight =
  ...
  resize : function(newSize) {
    ...
    //Offset the body's height by the panel's height
    document.getElementsByTagName('body')[0].style.minHeight =
      (this.panel.offsetHeight + this.bodyHeight) + 'px';
  },
