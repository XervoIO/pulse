...
this.didFlashBlock=this.specialWmodeCase=this.muted=false;this.filePattern=null;this.filePatterns={flash8:/\.mp3(\?.*)?$/i,flash9:/\.mp3(\?.*)?$/i};this.features={buffering:false,peakData:false,waveformData:false,eqData:false,movieStar:false};this.sandbox={};var g;try{g=typeof Audio!=="undefined"&&typeof(new Audio).canPlayType!=="undefined"}catch(i){g=false}this.hasHTML5=g;this.html5={usingFlash:null};this.flash={};this.ignoreFlash=this.html5Only=false;var h,d=this,l,p=navigator.userAgent,j=a,B=j.location.href.toString(),
n=document,$,P,k,v=[],I=false,J=false,q=false,w=false,pa=false,K,r,aa,C,D,Q,qa,ba,z,R,E,ca,da,S,F,ra,ea,sa,T,ta,L=null,fa=null,A,ga,G,U,V,ha,m,W=false,ia=false,ua,va,t=null,wa,X,M,x,ja,ka,xa,o,Fa=Array.prototype.slice,N=false,s,Y,ya,u,za,la=p.match(/(ipad|iphone|ipod)/i),Ga=p.match(/firefox/i),Ha=p.match(/droid/i),y=p.match(/msie/i),Ia=p.match(/webkit/i),O=p.match(/safari/i)&&!p.match(/chrome/i),Ja=p.match(/opera/i);g=p.match(/(mobile|pre\/|xoom)/i)||la;var ma=!B.match(/usehtml5audio/i)&&!B.match(/sm2\-ignorebadua/i)&&
...
null;if(g&&(d.useHTML5Audio=true,d.preferFlash=false,la))N=d.ignoreFlash=true;this.supported=this.ok=function(){return t?q&&!w:d.useHTML5Audio&&d.hasHTML5};this.getMovie=function(a){return l(a)||n[a]||j[a]};this.createSound=function(a){function c(){b=U(b);d.sounds[f.id]=new h(f);d.soundIDs.push(f.id);return d.sounds[f.id]}var b=null,e=null,f=null;if(!q||!d.ok())return ha("soundManager.createSound(): "+A(!q?"notReady":"notOK")),false;arguments.length===2&&(a={id:arguments[0],url:arguments[1]});f=b=
r(a);if(m(f.id,true))return d.sounds[f.id];if(X(f))e=c(),e._setup_html5(f);else{if(k>8){if(f.isMovieStar===null)f.isMovieStar=f.serverURL||(f.type?f.type.match(Da):false)||f.url.match(Ka);if(f.isMovieStar&&f.usePeakData)f.usePeakData=false}f=V(f,"soundManager.createSound(): ");e=c();if(k===8)d.o._createSound(f.id,f.loops||1,f.usePolicyFile);else if(d.o._createSound(f.id,f.url,f.usePeakData,f.useWaveformData,f.useEQData,f.isMovieStar,f.isMovieStar?f.bufferTime:false,f.loops||1,f.serverURL,f.duration||
null,f.autoPlay,true,f.autoLoad,f.usePolicyFile),!f.serverURL)e.connected=true,f.onconnect&&f.onconnect.apply(e);!f.serverURL&&(f.autoLoad||f.autoPlay)&&e.load(f)}!f.serverURL&&f.autoPlay&&e.play();return e};this.destroySound=function(a,c){if(!m(a))return false;var b=d.sounds[a],e;b._iO={};b.stop();b.unload();for(e=0;e<d.soundIDs.length;e++)if(d.soundIDs[e]===a){d.soundIDs.splice(e,1);break}c||b.destruct(true);delete d.sounds[a];return true};this.load=function(a,c){return!m(a)?false:d.sounds[a].load(c)};
this.unload=function(a){return!m(a)?false:d.sounds[a].unload()};this.onposition=function(a,c,b,e){return!m(a)?false:d.sounds[a].onposition(c,b,e)};this.start=this.play=function(a,c){return!q||!d.ok()?(ha("soundManager.play(): "+A(!q?"notReady":"notOK")),false):!m(a)?(c instanceof Object||(c={url:c}),c&&c.url?(c.id=a,d.createSound(c).play()):false):d.sounds[a].play(c)};this.setPosition=function(a,c){return!m(a)?false:d.sounds[a].setPosition(c)};this.stop=function(a){return!m(a)?false:d.sounds[a].stop()};
this.stopAll=function(){for(var a in d.sounds)d.sounds.hasOwnProperty(a)&&d.sounds[a].stop()};this.pause=function(a){return!m(a)?false:d.sounds[a].pause()};this.pauseAll=function(){var a;for(a=d.soundIDs.length;a--;)d.sounds[d.soundIDs[a]].pause()};this.resume=function(a){return!m(a)?false:d.sounds[a].resume()};this.resumeAll=function(){var a;for(a=d.soundIDs.length;a--;)d.sounds[d.soundIDs[a]].resume()};this.togglePause=function(a){return!m(a)?false:d.sounds[a].togglePause()};this.setPan=function(a,
c){return!m(a)?false:d.sounds[a].setPan(c)};this.setVolume=function(a,c){return!m(a)?false:d.sounds[a].setVolume(c)};this.mute=function(a){var c=0;typeof a!=="string"&&(a=null);if(a)return!m(a)?false:d.sounds[a].mute();else{for(c=d.soundIDs.length;c--;)d.sounds[d.soundIDs[c]].mute();d.muted=true}return true};this.muteAll=function(){d.mute()};this.unmute=function(a){typeof a!=="string"&&(a=null);if(a)return!m(a)?false:d.sounds[a].unmute();else{for(a=d.soundIDs.length;a--;)d.sounds[d.soundIDs[a]].unmute();
d.muted=false}return true};this.unmuteAll=function(){d.unmute()};this.toggleMute=function(a){return!m(a)?false:d.sounds[a].toggleMute()};this.getMemoryUse=function(){var a=0;d.o&&k!==8&&(a=parseInt(d.o._getMemoryUse(),10));return a};this.disable=function(a){var c;typeof a==="undefined"&&(a=false);if(w)return false;w=true;for(c=d.soundIDs.length;c--;)sa(d.sounds[d.soundIDs[c]]);K(a);o.remove(j,"load",D);return true};this.canPlayMIME=function(a){var c;d.hasHTML5&&(c=M({type:a}));return!t||c?c:a?!!(k>
...
a.type:null}]);typeof a.fatal!=="undefined"&&a.fatal&&d.disable()};ya=function(){if(!ma||!Y())return false;var a=d.audioFormats,c,b;for(b in a)if(a.hasOwnProperty(b)&&(b==="mp3"||b==="mp4"))if(d.html5[b]=false,a[b]&&a[b].related)for(c=a[b].related.length;c--;)d.html5[a[b].related[c]]=false};this._setSandboxType=function(){};this._externalInterfaceOK=function(){if(d.swfLoaded)return false;(new Date).getTime();d.swfLoaded=true;H=false;ma&&ya();y?setTimeout(P,100):P()};S=function(a,b){function e(a,b){return'<param name="'+
a+'" value="'+b+'" />'}if(I&&J)return false;if(d.html5Only)return ba(),d.oMC=l(d.movieID),P(),J=I=true,false;var f=b||d.url,g=d.altURL||f,h;h=da();var i,j,k=G(),m,o=null,o=(o=n.getElementsByTagName("html")[0])&&o.dir&&o.dir.match(/rtl/i),a=typeof a==="undefined"?d.id:a;ba();d.url=ta(oa?f:g);b=d.url;d.wmode=!d.wmode&&d.useHighPerformance?"transparent":d.wmode;if(d.wmode!==null&&(p.match(/msie 8/i)||!y&&!d.useHighPerformance)&&navigator.platform.match(/win32|win64/i))d.specialWmodeCase=true,d.wmode=
null;h={name:a,id:a,src:b,width:"auto",height:"auto",quality:"high",allowScriptAccess:d.allowScriptAccess,bgcolor:d.bgColor,pluginspage:Ca+"www.macromedia.com/go/getflashplayer",title:"JS/Flash audio component (SoundManager 2)",type:"application/x-shockwave-flash",wmode:d.wmode,hasPriority:"true"};if(d.debugFlash)h.FlashVars="debug=1";d.wmode||delete h.wmode;if(y)f=n.createElement("div"),j=['<object id="'+a+'" data="'+b+'" type="'+h.type+'" title="'+h.title+'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="'+
Ca+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="'+h.width+'" height="'+h.height+'">',e("movie",b),e("AllowScriptAccess",d.allowScriptAccess),e("quality",h.quality),d.wmode?e("wmode",d.wmode):"",e("bgcolor",d.bgColor),e("hasPriority","true"),d.debugFlash?e("FlashVars",h.FlashVars):"","</object>"].join("");else for(i in f=n.createElement("embed"),h)h.hasOwnProperty(i)&&f.setAttribute(i,h[i]);ea();k=G();if(h=da())if(d.oMC=l(d.movieID)||n.createElement("div"),
d.oMC.id){m=d.oMC.className;d.oMC.className=(m?m+" ":d.swfCSS.swfDefault)+(k?" "+k:"");d.oMC.appendChild(f);if(y)i=d.oMC.appendChild(n.createElement("div")),i.className=d.swfCSS.swfBox,i.innerHTML=j;J=true}else{d.oMC.id=d.movieID;d.oMC.className=d.swfCSS.swfDefault+" "+k;i=k=null;if(!d.useFlashBlock)if(d.useHighPerformance)k={position:"fixed",width:"8px",height:"8px",bottom:"0px",left:"0px",overflow:"hidden"};else if(k={position:"absolute",width:"6px",height:"6px",top:"-9999px",left:"-9999px"},o)k.left=
Math.abs(parseInt(k.left,10))+"px";if(Ia)d.oMC.style.zIndex=1E4;if(!d.debugFlash)for(m in k)k.hasOwnProperty(m)&&(d.oMC.style[m]=k[m]);try{y||d.oMC.appendChild(f);h.appendChild(d.oMC);if(y)i=d.oMC.appendChild(n.createElement("div")),i.className=d.swfCSS.swfBox,i.innerHTML=j;J=true}catch(q){throw Error(A("domError")+" \n"+q.toString());}}return I=true};R=function(){if(d.html5Only)return S(),false;if(d.o)return false;d.o=d.getMovie(d.id);if(!d.o)L?(y?d.oMC.innerHTML=fa:d.oMC.appendChild(L),L=null,I=
true):S(d.id,d.url),d.o=d.getMovie(d.id);d.oninitmovie instanceof Function&&setTimeout(d.oninitmovie,1);return true};Q=function(){setTimeout(qa,1E3)};qa=function(){if(W)return false;W=true;o.remove(j,"load",Q);if(H&&!na)return false;var a;q||(a=d.getMoviePercent());setTimeout(function(){a=d.getMoviePercent();!q&&Aa&&(a===null?d.useFlashBlock||d.flashLoadTimeout===0?d.useFlashBlock&&ga():T(true):d.flashLoadTimeout!==0&&T(true))},d.flashLoadTimeout)};z=function(){function a(){o.remove(j,"focus",z);
o.remove(j,"load",z)}if(na||!H)return a(),true;na=Aa=true;O&&H&&o.remove(j,"mousemove",z);W=false;a();return true};za=function(){var a,b=[];if(d.useHTML5Audio&&d.hasHTML5)for(a in d.audioFormats)d.audioFormats.hasOwnProperty(a)&&b.push(a+": "+d.html5[a]+(!d.html5[a]&&s&&d.flash[a]?" (using flash)":d.preferFlash&&d.flash[a]&&s?" (preferring flash)":!d.html5[a]?" ("+(d.audioFormats[a].required?"required, ":"")+"and no flash support)":""))};K=function(a){if(q)return false;if(d.html5Only)return q=true,
D(),true;var b;if(!d.useFlashBlock||!d.flashLoadTimeout||d.getMoviePercent())q=true,w&&(b={type:!s&&t?"NO_FLASH":"INIT_TIMEOUT"});if(w||a){if(d.useFlashBlock&&d.oMC)d.oMC.className=G()+" "+(d.getMoviePercent()===null?d.swfCSS.swfTimedout:d.swfCSS.swfError);C({type:"ontimeout",error:b});F(b);return false}if(d.waitForWindowLoad&&!pa)return o.add(j,"load",D),false;else D();return true};P=function(){if(q)return false;if(d.html5Only){if(!q)o.remove(j,"load",d.beginDelayedInit),d.enabled=true,K();return true}R();
try{d.o._externalInterfaceTest(false),ra(true,d.flashPollingInterval||(d.useHighPerformance?10:50)),d.debugMode||d.o._disableDebug(),d.enabled=true,d.html5Only||o.add(j,"unload",$)}catch(a){return F({type:"JS_TO_FLASH_EXCEPTION",fatal:true}),T(true),K(),false}K();o.remove(j,"load",d.beginDelayedInit);return true};E=function(){if(ca)return false;ca=true;ea();if(!s&&d.hasHTML5)d.useHTML5Audio=true,d.preferFlash=false;xa();d.html5.usingFlash=wa();t=d.html5.usingFlash;za();if(!s&&t)d.flashLoadTimeout=
...
void 0&&this._private.types[a][b]!=void 0&&this._private.types[a][b][e]!=void 0)for(var i=this._private.types[a][b][e].length,h=0;h<i;h++)this._private.types[a][b][e][h].callback.apply(f,g)},unsubscribe:function(a){if(this._private.types[a.objectType]!=void 0&&this._private.types[a.objectType][a.functionName]!=void 0&&this._private.types[a.objectType][a.functionName][a.callbackType]!=void 0){var b=this._private.types[a.objectType][a.functionName][a.callbackType],e;for(e in b)b[e]==a&&b.splice(e,1)}}});
pulse.plugin.PluginCallback=PClass.extend({init:function(a){this.objectType=a.objectType;this.functionName=a.functionName;this.callbackType=a.callbackType;this.callback=a.callback}});pulse.plugin.PluginCallbackTypes={onEnter:"onEnter",onExit:"onExit"};pulse=pulse||{};pulse.plugin=pulse.plugin||{};pulse.plugin.PluginCollection=PClass.extend({init:function(){this._private={};this._private.plugins=[]},add:function(a){this._private.plugins.push(a)},remove:function(a){for(var b in this._private.plugins)this._private.plugins[b]===a&&this._private.plugins.splice(b,1)},invoke:function(a,b,e,f,g){for(var i=this._private.plugins.length,h=0;h<i;h++)this._private.plugins[h].invoke(a,b,e,f,g)}});pulse.plugins=pulse.plugins||new pulse.plugin.PluginCollection;pulse=pulse||{};pulse.error={DuplicateName:function(a){throw"There is already an object with the name "+a+" on this layer.";},InvalidSource:function(){throw"Invalid source for pulse image.";}};pulse=pulse||{};pulse.util=pulse.util||{};pulse.util.find=function(a,b){var e=[];if(a instanceof Array)for(var f=0;f<a.length;f++)typeof a[f]=="function"&&typeof a[f].name=="function"&&a[f].name==b&&e.push(a[f]);else if(typeof a=="object")for(f in a)f==b&&e.push(a[f]);return e};pulse.util.intersects=function(a,b){for(var e=[{x:a.x,y:a.y},{x:a.x,y:a.y+a.height},{x:a.x+a.width,y:a.y},{x:a.x+a.width,y:a.y+a.height}],f=0;f<4;f++){var g=e[f];if(g.x<b.width&&g.x>b.x&&g.y<b.height&&g.y>b.y)return true}return false};
...
"mousemove"||a==="mouseup")&&this._private.isDragging){var e=b.world.x-this._private.dragPos.x,f=b.world.y-this._private.dragPos.y;if(this.dragMoveEnabled)this.position={x:this.position.x+e,y:this.position.y+f};this._private.dragPos={x:b.world.x,y:b.world.y}}a==="mouseup"&&this.killDrag(b);if(a=="mousemove")this._private.mousein=true}});pulse.Sprite.HIT_TEST_RECT="rect";pulse.Sprite.HIT_TEST_CONVEX="convex";pulse.Sprite.PLUGIN_TYPE="pulse.Sprite";pulse.Sprite.PLUGIN_DRAW="draw";
...
pulse.Layer=pulse.Visual.extend({init:function(a){pulse.plugins.invoke("pulse.Layer","init",pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);this._super(a);a=pulse.util.checkParams(a,{x:0,y:0,size:{width:0,height:0}});this.position.x=a.x;this.position.y=a.y;this.size=a.size;this.canvas.width=this.size.width;this.canvas.height=this.size.height;this.canvas.style.position="absolute";this.objects={};this._private.objectArray=[];this._private.orderedKeys=[];pulse.plugins.invoke("pulse.Layer","init",
pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},addNode:function(a){pulse.plugins.invoke("pulse.Layer","addNode",pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);if(a instanceof pulse.Visual){if(isNaN(a.zindex))a.zindex=this._private.orderedKeys.length+1;this.objects.hasOwnProperty(a.name)?pulse.error.DuplicateName(a.name):(this.objects[a.name]=a,this._private.objectArray.push(a),a.parent=this,a.updated=true,this._private.orderedKeys=pulse.util.getOrderedKeys(this.objects))}pulse.plugins.invoke("pulse.Layer",
"addNode",pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},removeNode:function(a){pulse.plugins.invoke("pulse.Layer","removeNode",pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);var b=a;if(a instanceof pulse.Visual)b=a.name;if(this.objects.hasOwnProperty(b)){if(this.objects[b]instanceof pulse.Visual){var e=this.objects[b].boundsPrevious;this._private.context.clearRect(e.x,e.y,e.width,e.height)}this.objects[b].parent=null;delete this.objects[b]}pulse.plugins.invoke("pulse.Layer","removeNode",
pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},getNode:function(a){return this.objects[a]},getNodesByType:function(a){var b={},e;for(e in this.objects)this.objects[e]instanceof a&&(b[e]=this.objects[e]);return b},update:function(a){pulse.plugins.invoke(pulse.Layer.PLUGIN_TYPE,pulse.Layer.PLUGIN_UPDATE,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);for(var b=false,e=this._private.objectArray.length,f=0;f<e;f++){var g=this._private.objectArray[f];if(g instanceof pulse.Visual){if(g.shuffled===
true)g.shuffled=false,b=true;g.update(a);if(g.updated)this.updated=true}}if(b)this._private.orderedKeys=pulse.util.getOrderedKeys(this.objects);this._super(a);pulse.plugins.invoke(pulse.Layer.PLUGIN_TYPE,pulse.Layer.PLUGIN_UPDATE,pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},draw:function(a){pulse.plugins.invoke(pulse.Layer.PLUGIN_TYPE,pulse.Layer.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);for(var b=false,e=this._private.objectArray.length,f=0;f<e;f++)if(this._private.objectArray[f].updated){b=
true;break}if(b){this._private.context.clearRect(0,0,this.size.width,this.size.height);for(b=0;b<this._private.orderedKeys.length;b++)if(e=this.objects[this._private.orderedKeys[b]],e instanceof pulse.Visual)e.visible?e.draw(this._private.context):e.updated=false}this._super(a);pulse.plugins.invoke(pulse.Layer.PLUGIN_TYPE,pulse.Layer.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},pointInBounds:function(a){return a.x>this.bounds.x&&a.x<this.bounds.x+this.bounds.width&&a.y>this.bounds.y&&
a.y<this.bounds.y+this.bounds.height},eventsCallback:function(a,b){if(!(typeof b==="undefined"||typeof b.position==="undefined")){b.parent.x=b.position.x;b.parent.y=b.position.y;var e=this.getNodesByType(pulse.Sprite),f,g;for(g in e)if(f=e[g],f.visible)if(pulse.events[a]==="mouse"||pulse.events[a]==="touch"){var i=f.bounds;b.position.x=b.parent.x-i.x;b.position.y=b.parent.y-i.y;b.sender=f;if(f.handleAllEvents||f.inCurrentBounds(b.parent.x,b.parent.y)){if(f.inCurrentBounds(b.parent.x,b.parent.y)&&
f.mousein===false)f.mousein=true,f.events.raiseEvent("mouseover",b);f.events.raiseEvent(a,b)}if(!f.inCurrentBounds(b.parent.x,b.parent.y)&&f.mousein===true)f.mousein=false,f.events.raiseEvent("mouseout",b);if(f.dropAcceptEnabled)for(var h in pulse.EventManager.DraggedItems)if(i=pulse.EventManager.DraggedItems[h],f.inCurrentBounds(b.parent.x,b.parent.y))b.target=i,f.draggedOverItems[h]?(b.sender=f,f.events.raiseEvent("dragover",b)):(f.draggedOverItems[h]=i,i.events.bind("dragdrop",f.itemDroppedCallback),
f.events.raiseEvent("dragenter",b));else if(f.draggedOverItems[h])delete f.draggedOverItems[h],b.target=i,i.events.unbindFunction("dragdrop",f.itemDroppedCallback),f.events.raiseEvent("dragexit",b)}else b.sender=f,f.events.raiseEvent(a,b)}}});pulse.Layer.PLUGIN_TYPE="pulse.Layer";pulse.Layer.PLUGIN_DRAW="draw";pulse.Layer.PLUGIN_UPDATE="update";pulse=pulse||{};
...
this,arguments)},draw:function(){pulse.plugins.invoke(pulse.Scene.PLUGIN_TYPE,pulse.Scene.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);for(var a=0;a<this._private.orderedKeys.length;a++){var b=this.layers[this._private.orderedKeys[a]];if(b.updated){var e=this._private.liveLayers[b.name].canvas,f=this._private.liveLayers[b.name].context;f.clearRect(0,0,e.width,e.height);b.visible===true?b.draw(f):b.updated=false}}pulse.plugins.invoke(pulse.Scene.PLUGIN_TYPE,pulse.Scene.PLUGIN_DRAW,
...
this.layers[e].events.raiseEvent("mouseover",b);this.layers[e].events.raiseEvent(a,b)}else if(this.layers[e].mousein===true)this.layers[e].mousein=false,this.layers[e].events.raiseEvent("mouseout",b)}else b.sender=this.layers[e],this.layers[e].events.raiseEvent(a,b)}});pulse.Scene.PLUGIN_TYPE="pulse.Scene";pulse.Scene.PLUGIN_DRAW="draw";pulse.Scene.PLUGIN_UPDATE="update";pulse=pulse||{};
pulse.SceneManager=PClass.extend({init:function(a){a=pulse.util.checkParams(a,{gameWindow:document.getElementsByTagName("body")[0]});this.scenes={};this.gameWindow=a.gameWindow},addScene:function(a){pulse.plugins.invoke("pulse.SceneManager","addScene",pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);if(a instanceof pulse.Scene&&!this.scenes.hasOwnProperty(a.name)){var b=this.gameWindow.clientWidth,e=this.gameWindow.clientHeight;b===0&&this.gameWindow.style.width&&(b=parseInt(this.gameWindow.style.width));e===
0&&this.gameWindow.style.height&&(e=parseInt(this.gameWindow.style.height));a.setDefaultSize(b,e);this.scenes[a.name]=a}pulse.plugins.invoke("pulse.SceneManager","addScene",pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},removeScene:function(a){pulse.plugins.invoke("pulse.SceneManager","removeScene",pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);if(a instanceof pulse.Scene)a=a.name;this.scenes.hasOwnProperty(a)&&delete this.scenes[a];pulse.plugins.invoke("pulse.SceneManager","removeScene",
pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},activateScene:function(a){if(a instanceof pulse.Scene)a=a.name;if(this.scenes.hasOwnProperty(a))this.scenes[a].active=true,this.gameWindow.appendChild(this.scenes[a].getSceneContainer())},deactivateScene:function(a){if(a instanceof pulse.Scene)a=a.name;if(this.scenes.hasOwnProperty(a)&&this.scenes[a].active)this.scenes[a].active=false,this.gameWindow.removeChild(this.scenes[a].getSceneContainer())},getScene:function(a){return this.scenes[a]},
getScenes:function(a){var b=[],e;for(e in this.scenes)a===true?this.scenes[e].active===true&&b.push(this.scenes[e]):b.push(this.scenes[e]);return b}});pulse=pulse||{};
...
1;this.gameWindow.appendChild(this._private.mainDiv);this.scenes=new pulse.SceneManager({gameWindow:this._private.mainDiv});this.masterTime=0;this.tick=100;this.loopLogic=null;this._private.currentTime=(new Date).getTime();this._private.lastTime=this._private.currentTime;pulse.plugins.invoke("pulse.Engine","init",pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},getWindowOffset:function(){var a=this._private.mainDiv.offsetLeft,b=this._private.mainDiv.offsetTop;if(this._private.mainDiv.offsetParent){var e=
this._private.mainDiv.offsetParent;do a+=e.offsetLeft,b+=e.offsetTop;while(e=e.offsetParent)}return{x:a,y:b}},bindEvents:function(){var a=this,b;for(b in pulse.events)window.addEventListener(b,function(b){a.windowEvent.call(a,b)},false),b==="mousewheel"&&window.addEventListener("DOMMouseScroll",function(b){a.windowEvent.call(a,b)},false)},go:function(a,b){this.tick=a;var e=this;this.bindEvents();if(b)this.loopLogic=b;requestAnimFrame(function(){e.loop.call(e)},this._private.mainDiv)},loop:function(a){pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,
pulse.Engine.PLUGIN_LOOP,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);var b=this;(a||a===void 0)&&requestAnimFrame(function(){b.loop.call(b)},this._private.mainDiv);this._private.currentTime=(new Date).getTime();var e=this._private.currentTime-this._private.lastTime;if(!(e<this.tick)){var f=Math.floor(e/30);f===0&&(f=1);if(f<20){e/=f;for(var g=0;g<f;g++)this.loopLogic&&this.loopLogic(this.scenes,e),this.update(e),this.draw(),this.masterTime+=e}this._private.lastTime=this._private.currentTime;
pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,pulse.Engine.PLUGIN_LOOP,pulse.plugin.PluginCallbackTypes.onExit,this,arguments)}},update:function(a){pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,pulse.Engine.PLUGIN_UPDATE,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);for(var b=this.scenes.getScenes(true),e=0;e<b.length;e++)b[e].update(a);pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,pulse.Engine.PLUGIN_UPDATE,pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},draw:function(){pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,
pulse.Engine.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onEnter,this,arguments);for(var a=this.scenes.getScenes(true),b=0;b<a.length;b++)a[b].draw();pulse.plugins.invoke(pulse.Engine.PLUGIN_TYPE,pulse.Engine.PLUGIN_DRAW,pulse.plugin.PluginCallbackTypes.onExit,this,arguments)},windowEvent:function(a){if(!this.hidden){if(!a)a=window.event;var b=a.type,e=this.scenes.getScenes(true),f=this.getWindowOffset(),g=0,i=0;window.pageXOffset&&window.pageYOffset?(g=window.pageXOffset,i=window.pageYOffset):(g=
document.body.scrollLeft,i=document.body.scrollTop);var h=new pulse.MouseEvent,d=a.clientX-f.x+g,l=a.clientY-f.y+i,p=false;if(pulse.events[b]==="touch"||pulse.events[b]==="touchgesture"){p=true;h=new pulse.TouchEvent;if(a.touches&&a.touches.length>0)d=a.touches[0].clientX-f.x+g,l=a.touches[0].clientY-f.y+i,h.touches=a.touches;if(a.changedTouches&&a.changedTouches.length>0)h.changedTouches=a.changedTouches,b==="touchend"&&(d=a.changedTouches[0].clientX-f.x+g,l=a.changedTouches[0].clientY-f.y+i);if(a.targetTouches&&
a.targetTouches.length>0)h.targetTouches=a.changedTouches;if(a.scale&&a.rotation)h.gestureScale=a.scale,h.gestureRotation=a.rotation;this.focused=true}h.window.x=a.clientX;h.window.y=a.clientY;h.world.x=d;h.world.y=l;f=false;d>0&&d<parseInt(this._private.mainDiv.style.width,10)&&l>0&&l<parseInt(this._private.mainDiv.style.height,10)&&(f=true);for(g=0;g<e.length;g++){h.parent.x=h.window.x;h.parent.y=h.window.y;h.position.x=d;h.position.y=l;if(f){if(a.preventDefault&&p===false&&a.preventDefault(),document.activeElement!==
this._private.mainDiv&&a.type.toLowerCase()==="click"&&(document.activeElement.blur(),this._private.mainDiv.focus()),a.type.toLowerCase()==="mousedown")this.focused=true}else{if(a.type.toLowerCase()==="mousedown")this.focused=false;e[g].events.raiseEvent("mouseout",h)}if(a.type.toLowerCase()==="mousewheel"||a.type.toLowerCase()==="dommousescroll")b=0,a.wheelDelta?b=a.wheelDelta/120:a.detail&&(b=-a.detail/3),h.scrollDelta=b,b="mousewheel";if(pulse.events[a.type]==="keyboard"){var j;if(a.charCode)j=
a.charCode;else if(a.keyCode)j=a.keyCode;else if(a.which)j=a.which;h.keyCode=j;h.key=String.fromCharCode(j)}if(this.focused)h.sender=e[g],e[g].events.raiseEvent(b,h)}if(a.type.toLowerCase()==="mouseup"&&!f)for(var B in pulse.EventManager.DraggedItems)B.indexOf("sprite")===0&&pulse.EventManager.DraggedItems[B].killDrag(h)}},addScene:function(a){this.scenes&&this.scenes.addScene&&this.scenes.addScene(a)},removeScene:function(a){this.scenes&&this.scenes.addScene&&this.scenes.removeScene(a)},activateScene:function(a){this.scenes&&
