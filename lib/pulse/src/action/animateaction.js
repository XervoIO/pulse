...
/** @lends pulse.AnimateAction.prototype */
{
  ...
  init : function(params) {
    ...
    /**
     * @private
     * The delay in number of milliseconds on a loop.
     * @type {number}
     */
    ...
    /**
     * @private
     * The current delay time inbetween the loops.
     * @type {number}
     */
  ...
  update : function(elapsed)
  {
    ...
    if(this._private.currentPlay > 1 &&
       this._private.delayTime <= this._private.loopDelay) {
