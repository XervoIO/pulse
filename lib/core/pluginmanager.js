 ...
 */
pulse.plugin.PluginManager = PClass.extend(
/** @lends pulse.PluginManager.prototype */
{
	/** @constructs */
	init : function() {
	...
	/**
   	...
   	* @param {type} objectType The object type to subscribe functions 
...
pulse.plugin.pluginManager = new pulse.plugin.PluginManager();