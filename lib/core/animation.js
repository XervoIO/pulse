...
PFPlay.Animation = function(name, size, frames, frameRate, options)
{
  ...
  frames = PFPlay.util.checkValue(frames, 0);
  frameRate = PFPlay.util.checkValue(frameRate, 999999);
  options = PFPlay.util.checkProperty(
    options, 'offset', {x:0, y:0});
  
  /** Frame size */
  size = PFPlay.util.checkValue(size, {x:0, y:0});
