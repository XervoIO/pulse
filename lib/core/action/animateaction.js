 ...
 * on the node
 * @config {PFPlay.Sprite} target the sprite for the action to be performed on
 ...
 * @augments PFPlay.Action
 * @copyright 2011 Paranoid Ferret Productions
 */
 
PFPlay.AnimateAction = PFPlay.Action.extend(
/** @lends PFPlay.AnimateAction.prototype */
{
  /** @constructs */ 
  ...
  {
    var frame = PFPlay.util.checkValue(index, this._private.currentFrame);
  ...
  start : function() {
    this._super();
    this._private.currentPlay = 1;
    this._private.frameOriginal = this.target.textureFrame;
  },
