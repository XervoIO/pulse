 ...
 * on the node
 * @config {string|PFPlay.BitmapFont} font the font filename to use or a 
 * PFPlay.BitmapFont to use
...
PFPlay.BitmapLabel = PFPlay.Visual.extend(
/** @lends PFPlay.BitmapLabel.prototype */
{
  /** @constructs */
  init: function(params) {
    ...
    if(typeof params.font == 'object') {
      ...
      this.font = new PFPlay.BitmapFont({
