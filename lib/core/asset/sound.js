...
/** @lends PFPlay.Sound.prototype */
{
  ...
  init : function(params) {
    ...
    if(this.autoLoad && (this._private.type == 'html5' ||
      (this._private.type == 'flash' && PFPlay.Sound.FlashReady))) {
      this.load();
    }
  },
  ...
  initFlashPlayer : function() {
    if(PFPlay.Sound.FlashInitialized == false) {
      PFPlay.Sound.FlashInitialized = true;
      window.soundManager = new SoundManager(PFPlay.libsrc + '/other/');
      soundManager.beginDelayedInit();
      soundManager.flashVersion = 8;
      soundManager.useFlashBlock = false;
      soundManager.onready(function() {
        PFPlay.Sound.FlashReady = true;
        if(this.autoLoad) {
          this.load();
        }
      }, this);
    ...
    } else if(PFPlay.Sound.FlashReady == false){
      soundManager.onready(function() {
        if(this.autoLoad) {
          this.load();
        }
...
PFPlay.Sound.FlashInitialized = false;
PFPlay.Sound.FlashReady = false;