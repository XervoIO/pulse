          ...
          if(keyval.length > 1) {
            switch(keyval[0]) {
              case "id":
                ...
                break;
              case "x":
                character.position.x = parseInt(keyval[1], 10);
                break;
              case "y":
                character.position.y = parseInt(keyval[1], 10);
                break;
              case "width":
                character.size.width = parseInt(keyval[1], 10);
                break;
              case "height":
                character.size.height = parseInt(keyval[1], 10);
                break;
              case "xoffset":
                character.offset.x = parseInt(keyval[1], 10);
                break;
              case "yoffset":
                character.offset.y = parseInt(keyval[1], 10);
                break;
              case "xadvance":
                character.xAdvance = parseInt(keyval[1], 10);
                break;
              case "page":
                character.page = parseInt(keyval[1], 10);
                break;
            }
          }
        }
