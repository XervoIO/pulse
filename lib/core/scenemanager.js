...
PFPlay.SceneManager = PClass.extend(
/** @lends PFPlay.SceneManager.prototype */
{
  /** @constructs */
   ...
   * @param {PFPlay.Scene} scene the scene to add
   */
   ...
   * @param {string} name the scene name
   * @return {PFPlay.Scene} scene from the scenes object by name
   */
