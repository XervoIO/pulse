...
pulse.debug.Panel = PClass.extend({init:function(params) {
  ...
  this.panel.style.cssText = "width: 100%; background-color: #333; color: #00FF00;" + "position: absolute; left: 0px; bottom: 0px; color: #ccc; " + "font: 12px Helvetica,arial,freesans,clean,sans-serif";
  ...
  this.topbar.onmousedown = function(e) {
    ...
    body.style.cssText = bodyStyle + "-webkit-touch-callout: none; -webkit-user-select: none;" + "-khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;";
    var mm = function(e) {
